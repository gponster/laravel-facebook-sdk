<h2 class="welcome">@lang('gponster/laravel-facebook-sdk::pages.create.title')</h2>
<p class="col-md-12">@lang('gponster/laravel-facebook-sdk::pages.create.desc',
		['site_name' => Config::get('settings.site_name')])</p>
<p class="col-md-12"><b>Facebook ({{$profile['email']}})</b></p>
<p class="col-md-12">@lang('gponster/laravel-facebook-sdk::pages.create.basic_info')</p>

{{ Form::open(['url'=>Config::get('gponster/laravel-facebook-sdk::routes.login'),
	...
	<div class="form-group">
		@lang('gponster/laravel-facebook-sdk::pages.create.password_tip',
	...
	<div class="form-group">
		{{ Form::submit(trans('gponster/laravel-facebook-sdk::pages.create.submit'),
			['class'=>'btn btn-primary']) }}&nbsp;
			<a href="{{URL::to(Config::get('gponster/laravel-facebook-sdk::routes.login'))}}?{{http_build_query(['cancel' => $profile['email']])}}">
				@lang('gponster/laravel-facebook-sdk::pages.create.cancel')
			</a>
	</div>
{{ Form::close() }}